        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            else
            {
                ...
                if (projectile.localAI[0] < 1f)
                {
                    ...
                    {
                        var gainSfx = new SoundStyle("LeagueOfLegendThings/Content/SFX/Dark_Harvest_SFX")
                        {
                            Volume = 0.8f,
                            PitchVariance = 0f
                        };
                ...
                if (distance < PickupDistance)
                {
                    if (projectile.localAI[0] < 2f)
                    {
                        ...
                        if (Main.netMode == NetmodeID.SinglePlayer)
                        {
                            var finalSfx = new SoundStyle("LeagueOfLegendThings/Content/SFX/Dark_Harvest_SFX_4")
                            {
                                Volume = 0.8f,
                                PitchVariance = 0f
                            };
